  ...
  <!-- Static navbar -->
   ...
   <div class="container">
     <div class="jumbotron">
       <div class="row">
         <div>
           <legend>History of Borrowers</legend>
            <ul class="list-group">
             @foreach($borrowers as $borrower)
              <li class="list-group-item">{{ $borrower->name }} <small>return date {{$borrower->deleted_at}}</small></li>
             @endforeach
           </ul>

           {{ $borrowers->links() }}
           <a href="/borrower" class="btn btn-primary pull-right" role="button">Back</a>
         </div>
       </div>
     </div>
   </div>
