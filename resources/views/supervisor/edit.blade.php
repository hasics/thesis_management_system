        ...
        <div>
            ...
            <form method="post" action="{{route('supervisor.update', [$supervisor->id])}}">
                ...
                <div class="form-group">
                    ...
                    <input type="text" class="form-control" id="name" name="name" placeholder="{{old('name', $supervisor->name)}}">
                </div>
                <div class="form-group">
                    <label for="phone_no" class="control-label">PHONE NO. *</label>
                    <input type="text" class="form-control" id="phone_no" name="phone_no" placeholder="{{old('phone_no', $supervisor->phone_no)}}">
                </div>
                <div class="form-group">
                    <label for="email" class="control-label">EMAIL *</label>
                    <input type="email" class="form-control" id="email" name="email" placeholder="{{old('email', $supervisor->email)}}">
                </div>
